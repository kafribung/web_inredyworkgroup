                            ...
                            <form action="/article/{{$article->id}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="title" name="title" type="text"
                                        ...
                                        autocomplete="off" value="{{old('title') ? old('title') : $article->title}}">
                                ...
                                <div class="form-group">
                                    <img src="{{url($article->takeImg)}}" alt="Gamabr {{$article->title}}"
                                        title="Gamabr {{$article->title}}" height="100">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description"
                                        class="form-control ckeditor @error('description') is-invalid @enderror">{{old('description') ? old('description') : $article->description }}</textarea>
