            ...
            <div class="col-lg-12">
                <div class="card-body ">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/user/{{$user->id}}" method="POST" novalidate enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="img" class="control-label mb-1">Foto</label>
                                    <img src="{{url($user->takeImg)}}" alt="Foto {{$user->name}}"
                                        title="Foto {{$user->name}}" height="100">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="nir" name="nir" type="number"
                                        ...
                                        autocomplete="off" value="{{old('nir') ? old('nir') : $user->nir}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" email="email"
                                        ...
                                        autocomplete="off" value="{{old('email') ? old('email') : $user->email}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="address" name="address"
                                        ...
                                        autocomplete="off">{{old('address') ? old('address') : $user->address}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="hp" name="hp" type="number"
                                        ...
                                        autocomplete="off" value="{{old('hp') ? old('hp') : $user->hp}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="job" name="job"
                                        ...
                                        autocomplete="off">{{old('job') ? old('job') : $user->job}}</textarea>
