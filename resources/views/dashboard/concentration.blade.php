                ...
                <div class="card-body ">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="/concentration/create" class="btn btn-primary btn-sm float-right"><i
                                    class="fa fa-plus"></i>
                            </a>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/concentration/{{$concentration->id}}/edit"
                                            ...
                                            <form action="/concentration/{{$concentration->id}}" method="POST"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    onclick="return confirm('Hapus Data {{$concentration->concentration}}?')"
